...
- [1. Design ETL Pipeline and Define Python Tasks](#1-design-etl-pipeline-by-defining-python-tasks)
- [2. Deploy Airflow Web Server within Docker to Execute Python Tasks](#2-deploy-airflow-web-server-within-docker-to-execute-python-tasks)
- [3. Restructure Data and Generate D3 Visualizations](#3-restructure-data-and-generate-d3-visualizations)

[Back to top](#end-to-end-data-processing-and-visualization-of-mit-course-catalog)

## 1. Design ETL Pipeline by Defining Python Tasks
