...
# End-to-End Data Processing and Visualization of MIT Course Catalog
...
[Go to repository](https://github.com/siconge/MIT-Course-Catalog-Data-Processing-Visualization)

## Table of Contents

- [Step 1: Design ETL Pipeline and Define Python Tasks](#step-1-design-etl-pipeline-by-defining-python-tasks)
- [Step 2: Deploy Airflow Web Server within Docker to Execute Python Tasks](#step-2-deploy-airflow-web-server-within-docker-to-execute-python-tasks)
- [Step 3: Restructure Data and Generate D3 Visualizations](#step-3-restructure-data-and-generate-d3-visualizations)

[Back to top](#end-to-end-data-processing-and-visualization-of-mit-course-catalog)

## Step 1: Design ETL Pipeline by Defining Python Tasks
...
## Step 2: Deploy Airflow Web Server within Docker to Execute Python Tasks
...
![docker_containers](assets/airflow_docker_containers.png)

![airflow_dag_graph](assets/airflow_dag_graph.png)

[Back to top](#end-to-end-data-processing-and-visualization-of-mit-course-catalog)

## Step 3: Restructure Data and Generate D3 Visualizations
